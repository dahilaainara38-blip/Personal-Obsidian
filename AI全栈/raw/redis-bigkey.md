---
title: "Redis 大 Key 对持久化有什么影响？"
source: "https://www.xiaolincoding.com/redis/storage/bigkey_aof_rdb.html"
author:
  - "[[小林coding]]"
published: undefined
created: 2026-09-18
...
![·](https://cdn.xiaolincoding.com//mysql/other/2ae06f60d9614da0be4729944b2a317c.png)
...
![](https://cdn.xiaolincoding.com//mysql/other/def7d5328829470c9f3cfd15bbcc6814.png)
...
我们可以执行 `info` 命令获取到 latest\_fork\_usec 指标，表示 Redis 最近一次 fork 操作耗时。
...
- 在主从架构中，要适当调大 repl-backlog-size，避免因为 repl\_backlog\_buffer 不够大，导致主节点频繁地使用全量同步的方式，全量同步的时候，是会创建 RDB 文件的，也就是会调用 fork 函数。
...
← [RDB 快照是怎么实现的？](https://www.xiaolincoding.com/redis/storage/rdb.html) [Redis 过期删除策略和内存淘汰策略有什么区别？](https://www.xiaolincoding.com/redis/module/strategy.html) →